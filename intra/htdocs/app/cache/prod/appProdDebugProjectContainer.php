...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'code0123', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Framework/UserBundle/Resources/config/doctrine') => 'Framework\\UserBundle\\Entity'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($a, 'FOS\\UserBundle\\Entity');
        $c->addDriver($b, 'Framework\\UserBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'FrameworkUserBundle' => 'Framework\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ddaef892d08f2c3c2ec7539eabfaf93a8a4c399749edb2c3c6bfa4a21869cacc');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Framework\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Framework\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Framework\\UserBundle\\Entity\\User');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Framework/BaseBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Framework/BaseBundle/Resources/views'), 'Base');
        $instance->addPath(($this->targetDirs[3].'/src/Framework/UserBundle/Resources/views'), 'FrameworkUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('934231011d8e7d4dafd3718e312edff2d');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BaseBundle' => 'Framework\\BaseBundle\\BaseBundle',
                'FrameworkUserBundle' => 'Framework\\UserBundle\\FrameworkUserBundle',
            ),
            ...
            'database_user' => 'root',
            'database_password' => 'code0123',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '934231011d8e7d4dafd3718e312edff2d',
            ...
            'kernel.secret' => '934231011d8e7d4dafd3718e312edff2d',
            ...
            'assetic.ruby.bin' => '/Volumes/Data/nfs/zfs-student-3/users/2013/mmole/mamp/ruby/bin/ruby',
            ...
            'fos_user.model.user.class' => 'Framework\\UserBundle\\Entity\\User',
